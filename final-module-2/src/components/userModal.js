...
const userModals = () => {
    ...
    <div class="js-profile-modal hidden fixed z-101 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6 bg-gray-900 text-white rounded-xl shadow-2xl border border-gray-700">
        ...
        <form class="flex flex-col gap-4">
            <div>
                ...
                <input class="js-update-name w-full mt-1 bg-gray-800 border border-transparent focus:border-white outline-none px-4 py-2 rounded" type="text">
            </div>
            <div>
                <label class="text-xs text-gray-400 uppercase font-bold">Email</label>
                <input class="js-update-email w-full mt-1 bg-gray-800 border border-transparent focus:border-white outline-none px-4 py-2 rounded" type="email">
            </div>
    ...
    <div class="js-password-modal hidden fixed z-101 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6 bg-gray-900 text-white rounded-xl shadow-2xl border border-gray-700">
        ...
        <form class="flex flex-col gap-4">
            <input class="js-old-pass w-full bg-gray-800 px-4 py-2 rounded outline-none border border-transparent focus:border-white" type="password" placeholder="Mật khẩu cũ">
            <input class="js-new-pass w-full bg-gray-800 px-4 py-2 rounded outline-none border border-transparent focus:border-white" type="password" placeholder="Mật khẩu mới">
            <input class="js-confirm-new-pass w-full bg-gray-800 px-4 py-2 rounded outline-none border border-transparent focus:border-white" type="password" placeholder="Nhập lại mật khẩu mới">
